...
export const agentTasks = mysqlTable("agent_tasks", {
  ...
  plan: text("plan"),
  status: mysqlEnum("status", ["pending", "planning", "running", "paused", "completed", "failed", "killed"]).default("pending").notNull(),
  type: varchar("type", { length: 64 }).default("local_agent").notNull(),
  parentTaskId: int("parentTaskId"),
  description: text("description"),
  currentStep: int("currentStep").default(0).notNull(),
  totalSteps: int("totalSteps").default(0).notNull(),
  outputFile: varchar("outputFile", { length: 255 }),
  outputOffset: int("outputOffset").default(0).notNull(),
  result: text("result"),
...
export const memories = mysqlTable("memories", {
  ...
  type: mysqlEnum("type", ["episodic", "durable"]).default("episodic").notNull(),
